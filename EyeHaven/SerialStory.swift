...
enum SerialLibrary {
    ...
    /// 3-5 岁：知识还是真的，外壳是一趟收灯的出门。假传说先响，真答案才肯进灯。
    static let littleQuestion = SerialSeries(
        id: "little-question",
        age: .little,
        title: "光光出门",
        pitch: "窗台上有一张旧纸条：路灯亮起前，收回十二个真的。假的会把灯喂瘦。光光笑着出门，心里却很硬：好听的谎话，一盏都不收。",
        episodes: [
            .init(
                id: "q-01",
                number: 1,
                title: "天为什么是蓝的",
                hook: "有人说天是一桶蓝颜料打翻了。灯不亮。真答案收回来，傍晚却偷偷换了红衣服。",
                text: """
                窗台上住着光光。圆脑袋，会笑，头上一颗小星星。胸口有一盏暖灯。灯最近瘦了一圈。
                纸条是旧的，边都毛了：“出门十二次。只收回真的。假的会把灯喂瘦。”光光屏幕上还在笑，手指却按住灯。它不要假的。
                有人指着天说：“那是巨人打翻了蓝颜料。”光光喜欢这句话，几乎要点头。灯却一点也不亮。它把笑收小一点，去问太阳。
                太阳说：“我的光里藏着许多颜色。空气最爱把蓝色推来推去，蓝色就铺满了上面。不是颜料。是蓝光最会散开。”
                光光把这句话喂进灯。灯“叮”地亮了一粒。头顶的星星也跟着亮了一粒。假的蓝桶，它丢掉了。
                傍晚，天忽然穿上红衣服。有人又说：“太阳流血了。”灯又暗了一下。光光站在门口，不进门。
                太阳已经落到楼后面，只丢下一句：“光走远了，会换一件衣服。红的，还在路上。”
                第一集到这里。蓝的是真的。红的那件衣服，要等下一回出门。
                """
            ),
            .init(id: "q-02", number: 2, title: "晚霞为什么是红的", hook: "不是太阳流血。光走远了，蓝的先散掉，红的留下来。天全黑以后，红又去了哪？", text: nil),
            .init(id: "q-03", number: 3, title: "月亮为什么好像跟着走", hook: "有人说月亮在跟踪你。树会溜走，月亮几乎不动，因为它太远。那眨眼睛的，是谁？", text: nil),
            .init(id: "q-04", number: 4, title: "星星为什么会眨眼", hook: "不是星星在使眼色。它自己是稳的，空气把光弯了一下。天上忽然划过一条亮线，是星星在搬家吗？", text: nil),
            .init(id: "q-05", number: 5, title: "流星不是星星在搬家", hook: "那是小石头擦亮空气。灯又亮一粒。下雨了，有人说天在哭。灯又不答应。", text: nil),
            .init(id: "q-06", number: 6, title: "雨点为什么会唱歌", hook: "不是云在弹琴。小水滴敲叶子，空气就响。雨停了，天上为什么偷偷挂上一条彩带子？", text: nil),
            .init(id: "q-07", number: 7, title: "彩虹是怎么挂上去的", hook: "没有人爬上去钉钉子。小水滴把白光拆开。彩带子走了，衣服上的水珠还会闪，是同一件宝物吗？", text: nil),
            .init(id: "q-08", number: 8, title: "影子为什么跟着我", hook: "有人说那是另一个自己。其实身体挡住光，才有影子。关灯以后它回家了。那镜子里的人呢？", text: nil),
            .init(id: "q-09", number: 9, title: "镜子里为什么有另一个我", hook: "不是镜子里关着一个小孩。光撞上玻璃再折回来，左右却反了。书在里面为什么反着写？", text: nil),
            .init(id: "q-10", number: 10, title: "为什么会打哈欠", hook: "不是有人把困意传染成魔法。身体在说该歇了。看见别人打哈欠，自己也会。睡觉时眼睛为什么要关上？", text: nil),
            .init(id: "q-11", number: 11, title: "人为什么一定要睡觉", hook: "不是被夜收走。脑子要整理白天，眼睛的肌肉要松开。不睡，明天会慢。可小猫夜里为什么还看得见？", text: nil),
            .init(id: "q-12", number: 12, title: "小猫夜里为什么看得清", hook: "眼睛后面像有小镜子。你不是小猫，夜里可以暗一点。十二粒真的收回来，灯圆了。纸条翻面：明天换一条路。", text: nil)
        ]
    )
